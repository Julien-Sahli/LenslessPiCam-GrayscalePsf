...
def remote_display(fp, hostname, pad, vshift, brightness, psf, black, hshift, screen_res):
    ...
    if screen_res:
        ...
        # create image, kernel_size of https://www.dell.com/en-us/work/shop/dell-ultrasharp-usb-c-hub-monitor-u2421e/apd/210-axmg/monitors-monitor-accessories#techspecs_section
